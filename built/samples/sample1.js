...
console.log(miniscule_1.default
    .from(shipaddress)
    .join(miniscule_1.default.from(address), function (s) { return s.address_id; }, function (s) { return s.address_id; }, function (s, a) { return ({ myShip: s.ship_id, thatPrefix: a.prefix }); })
